...
def check_login(args):
    ip_range, username, password, success_file = args
...
def process_ranges(ip_ranges_file, username, password, success_file):
    ...
    with ThreadPoolExecutor(max_workers=130) as executor:
        args = ((ip_range, username, password, success_file) for ip_range in ip_ranges)
...
def main():
    ...
    process_ranges(ip_ranges_file, username, password, success_file)  # перебор диапазонов
